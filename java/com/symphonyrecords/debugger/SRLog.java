...
import static com.symphonyrecords.debugger.DebuggerService.setDebugText;
        ...
        if (null != msg) {
            ...
            try {
                if (!TextUtils.isEmpty(a)) {
                    setDebugText(a, R.color.debug_color);
            ...
            try {
                if (!TextUtils.isEmpty(a)) {
                    switch (type) {
                        ...
                        case V:
                            setDebugText(a, R.color.verbose_color);
                            Log.v(tag, a);
                            break;
                        ...
                        case I:
                            setDebugText(a, R.color.info_color);
                            Log.i(tag, a);
                            break;

                        case W:
                            setDebugText(a, R.color.warn_color);
                            Log.w(tag, a);
                            break;

                        case E:
                            setDebugText(a, R.color.error_color);
                            Log.e(tag, a);
                            break;

                        case WTF:
                            setDebugText(a, R.color.assert_color);
                            Log.wtf(tag, a);
                            break;
